/** @page Cosmic_template_project Template project for ST Visual Develop (STVD) toolchain with Cosmic compiler

  @verbatim
  *********************** (C) COPYRIGHT STMicroelectronics *********************
  * @file    Templates/STVD/Cosmic/readme.txt 
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    06-March-2012
  * @brief   Template project for ST Visual Develop (STVD) toolchain with Cosmic compiler
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  ...
  - Template\STVD\Cosmic
     ...
     - stm8tl5x_interrupt_vector.c Interrupt vectors table
