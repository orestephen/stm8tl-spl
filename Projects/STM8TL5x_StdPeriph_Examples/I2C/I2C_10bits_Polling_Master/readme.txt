/** @page I2C_10bits_Polling_Master I2C - 10bits address transfer in Polling mode (master)

  @verbatim
  *********************** (C) COPYRIGHT STMicroelectronics *********************
  * @file    I2C/I2C_10bits_Polling_Master/readme.txt 
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    06-March-2012
  * @brief   10bits address transfer in Polling mode (master)
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  ...
  This example provides a short description of how to send data with 10bits addressing mode
  using I2C.

  @par Directory contents

  - I2C\I2C_10bits_Polling_Master\main.c                       Main file containing the "main" functions 
  - I2C\I2C_10bits_Polling_Master\stm8tl5x_conf.h              Library Configuration file
  - I2C\I2C_10bits_Polling_Master\stm8tl5x_it.c                Interrupt routines source (not used in this example)
  - I2C\I2C_10bits_Polling_Master\stm8tl5x_it.h                Interrupt routines declaration
