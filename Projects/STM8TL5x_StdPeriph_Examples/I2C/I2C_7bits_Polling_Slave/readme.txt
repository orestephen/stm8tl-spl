/** @page I2C_7bits_Polling_Slave I2C - 7bits address transfer in Polling mode (slave)

  @verbatim
  *********************** (C) COPYRIGHT STMicroelectronics *********************
  * @file    I2C/I2C_7bits_Polling_Slave/readme.txt 
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    06-March-2012
  * @brief   7bits address transfer in Polling mode (slave)
  ******************************************************************************
  * @attention
  *
  ...
  ******************************************************************************
  ...
  - I2C\I2C_7bits_Polling_Slave\main.c                       Main file containing the "main" functions 
  - I2C\I2C_7bits_Polling_Slave\stm8tl5x_conf.h              Library Configuration file
  - I2C\I2C_7bits_Polling_Slave\stm8tl5x_it.c                Interrupt routines source (not used in this example)
  - I2C\I2C_7bits_Polling_Slave\stm8tl5x_it.h                Interrupt routines declaration
