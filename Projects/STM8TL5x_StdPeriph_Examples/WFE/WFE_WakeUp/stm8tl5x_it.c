/**
  ******************************************************************************
  * @file    WFE/WFE_WakeUp/stm8tl5x_it.c
...
{
  /* Note: This interrupt is not served due to the WFE mode */
...
{
	/* This interrupt routine is served but doesn't allow to
	   exit from the WFE mode */
